          ...
          {timeFilter && (
            <div className="border border-gray-400 rounded-xl p-6 w-fit bg-white space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <select
                  className="border rounded-lg px-5 py-3.5 w-72 text-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  value={timeRange}
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="border rounded-lg px-5 py-3.5 w-57 text-base focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
