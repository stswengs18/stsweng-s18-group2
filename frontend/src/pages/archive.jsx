          ...
          {timeFilter && (
            <div className="border border-gray-400 rounded-xl p-6 w-fit bg-white space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <select
                  className="border rounded-lg px-7 py-4 w-72 text-3x1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  value={timeRange}
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="border rounded-lg px-7 py-4 w-57 text-3x1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
